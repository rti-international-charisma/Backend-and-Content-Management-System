...
class AmazonWebServicesS3Storage extends drive_1.Storage {
    constructor(config) {
        ...
        this.$root = config.root ? path_1.default.normalize(config.root) : '';
    }
    /**
     * Prefixes the given filePath with the storage root location
     */
    _fullPath(filePath) {
        return path_1.default.join(this.$root, filePath);
    }
    /**
...
//# sourceMappingURL=AmazonWebServicesS3Storage.js.map