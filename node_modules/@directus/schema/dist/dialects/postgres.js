...
var postgres_1 = __importDefault(require("knex-schema-inspector/dist/dialects/postgres"));
                        ...
                        _loop_1 = function (column) {
                            if (column.table_name in overview === false)
                                overview[column.table_name] = {
                                    primary: (_a = primaryKeys.find(function (key) { return key.table_name === column.table_name; })) === null || _a === void 0 ? void 0 : _a.column_name,
                                    columns: {},
                                };
